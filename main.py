...
from routes.mobile_constructions_routes import mobile_constructions
...
@app.route('/mobile_constructions', methods=['GET', 'POST'])
def mobile_constructions_page():
	return mobile_constructions()
